...
public class QuestBuyX extends Questable {

    public QuestBuyX(Core instance) {
        super("Shopping Addict", Material.EMERALD, instance);
    }
    ...
    public String[] getDescription(QuestWrapper questWrapper) {
        ...
        return new String[]{
                ...
                ChatColor.YELLOW + "Buy " + ChatColor.AQUA + getRequired(questWrapper) + "" + ChatColor.YELLOW + " items to complete this quest"
        };
    }

    @EventHandler(priority = EventPriority.MONITOR)
    public void onBuy(ItemBuyEvent event) {
