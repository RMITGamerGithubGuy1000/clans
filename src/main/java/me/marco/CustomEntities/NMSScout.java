...
public class NMSScout extends Wolf {

    public NMSScout(Core core, org.bukkit.entity.Player owner, Location loc, org.bukkit.entity.Player targetPlayer) {
        ...
        this.goalSelector.addGoal(10, new ScoutPathfinder(core, owner,this, 2D, 2D, nmsTarget));
