...
import me.marco.CustomEntities.PathFinders.FirefoxPathfinder;
...
public class NMSFox extends Fox {

    public NMSFox(Core core, org.bukkit.entity.Player owner, Location loc, org.bukkit.entity.Player targetPlayer) {
        ...
        this.goalSelector.addGoal(10, new FirefoxPathfinder(core, owner,this, 2D, 2D, nmsTarget));
