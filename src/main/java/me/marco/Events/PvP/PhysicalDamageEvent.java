...
public class PhysicalDamageEvent extends Event implements Cancellable {
    ...
    public PhysicalDamageEvent(Player damager, Player target, double damage) {
        this.damager = damager;
        this.target = target;
        this.damage = damage;
    }

    public PhysicalDamageEvent(Player damager, Player target, double damage, String cause) {
        this.damager = damager;
        this.target = target;
        this.damage = damage;
        this.cause = cause;
