...
public class FlameTrail extends ArrowTrail {

    public FlameTrail(String cosmeticTag) {
        super(cosmeticTag, Material.CAMPFIRE);
    }
    ...
    public void playEffect(Core instance, Arrow arrow) {
        new BukkitRunnable(){
            public void run(){
                ...
                UtilParticles.playEffect(arrow.getLocation(), Particle.FLAME, 0, 0, 0, 0, 1);
            }
